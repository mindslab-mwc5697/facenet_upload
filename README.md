# Face Recognition Algorithm based on github.facenet-pytorch

## Overview

* 본 장에서 개발한 face recognition 알고리즘은 [github.facenet-pytorch](https://github.com/timesler/facenet-pytorch.git
)] 를 기반으로 개발했다.
* 표준 인터페이스 구현, 기능 추가, 및 성능 향상을 위해 github.facenet-pytorch 에서 아래 언급한 코드를 수정했다.
